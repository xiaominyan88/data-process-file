...
import com.hyit.zhny.coud.lock.AbstractQueuedSynchronizer;
    ...
    abstract static class Sync extends AbstractQueuedSynchronizer {
        ...
        protected final boolean tryAcquire(int acquires){
            ...
            if(c != 0){
                ...
                if(w + exclusiveCount(acquires) > MAX_COUNT){
                    throw new Error("Maximum Count Lock Exceeded");
                }
                setState(c + acquires);
                return true;
            }
        ...
        final boolean tryWriteLock(){
            ...
            if(c != 0){
                ...
                if(w == MAX_COUNT) throw new Error("Maxmum lock count exceeded");
            }
        ...
        final long getWriteHoldCount(){
            return isHeldExclusively()?exclusiveCount(getState()) : 0l;
        }
